...
abstract class ColorStyles {
  static const Color primary = Color(0xFFE74750);
  static const Color black = Color(0xFF000000);
  static const Color black2 = Color(0xFF222222);
  static const Color gray1 = Color(0xFF444444);
  static const Color gray2 = Color(0xFF6C7275);
  static const Color gray3 = Color(0xFF999999);
  static const Color gray4 = Color(0xFFE5E5E5);
  static const Color gray5 = Color(0xFFF9F9F9);
  static const Color gray6 = Color(0xFF535353);
  static const Color gray7 = Color(0xFFF5F5F5);
  static const Color white = Color(0xFFFFFFFF);

  static const Color blue1 = Color(0xFF4285F4);
